        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Timezone = table.Column<string>(type: "text", nullable: false, defaultValue: "Asia/Kolkata"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_daily_checkins_users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Struggles = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FrequencyConfig = table.Column<string>(type: "jsonb", nullable: false, defaultValue: "{}"),
                    ReminderTime = table.Column<TimeOnly>(type: "time without time zone", nullable: true),
                    Color = table.Column<string>(type: "text", nullable: false, defaultValue: "#7C5CFF"),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_daily_checkins_UserId_Date",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_weekly_reviews_UserId_WeekStart",
